...
| **SLI Measurement** | **(a)** Prometheus counter `workflow_execution_total{status="success"}`, `failed`, or `timeout`. **(b)** Histogram `workflow_execution_duration_seconds` with buckets [60, 300, 600, 1800, 3600, 7200, 14400]. Segmented by `workflow_type`. |
