...
1. **Necessity of Architecture First**: The isolation of environments within the unified Workflow Engine (Exploration Environment / Freeze Pipeline / Production Environment / Cross-Environment Read-Only Mode, per ADR-0005 refined by ADR-0025) is the most critical architectural decision and must be established before any component design.
